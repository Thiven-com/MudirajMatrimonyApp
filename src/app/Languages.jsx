...
const removeDuplicateLanguages = (
  languages
) => {
  const result = [];
  ...
  if (
    ...
    if (
      ...
      try {
        ...
        console.log(
          "LANGUAGE OBJECT JSON PARSE ERROR:",
          error
        );
      }
    }
