...
export default function EducationInformation() {
    ...
    const loadEducation = useCallback(async () => {
        try {
            ...
            const response =
                await getMemberEducation(accessToken);

            console.log(
                "GET EDUCATION RESPONSE:",
                ...
                >
                    ...
                    {!loading && (
                        ...
                        >
                            ...
                            <Text
                                style={
                                    styles.addEducationDescription
                                }
                            >
                                Help others know about your
