...
export default function CareerInformation() {
    ...
    const handleAddCareer = () => {
        ...
        try {
            ...
            console.error(
                "ADD CAREER NAVIGATION ERROR:",
                error
            );

            Alert.alert(
                "Navigation Error",
                "Unable to open Add Career screen."
            );
        }
    };
