    ...
    <View style={styles.sectionHeader}>
      <View style={styles.sectionTitleRow}>
        <View style={styles.sectionTitleIcon}>
          <Ionicons name={icon} size={scale(22)} color={COLORS.red} />
        </View>
      ...
      {showViewAll && (
        <TouchableOpacity
          ...
          activeOpacity={0.8}
          onPress={() => Alert.alert(title, `Opening all ${title}`)}
        >
...
const PersonalItem = ({ item }) => {
  return (
    <View style={styles.personalItem}>
      ...
      >
        <Ionicons name={item.icon} size={scale(19)} color={item.color} />
      </View>

      <View style={styles.personalTextContainer}>
        <Text style={styles.personalLabel} numberOfLines={2}>
          {item.label}
        </Text>
  ...
  return (
    <View style={styles.familyItem}>
      ...
      <View style={styles.familyTextContainer}>
        <Text style={styles.familyLabel} numberOfLines={2}>
          {item.label}
        </Text>

        <Text style={styles.familyValue} numberOfLines={2}>
          {item.value}
        </Text>
      </View>
    </View>
...
export default function ProfileDetails() {
  ...
  useEffect(() => {
    const countryId = presentAddressForm.country_id;
  ...
  useEffect(() => {
    const stateId = presentAddressForm.state_id;
  ...
  const loadProfileDetails = async () => {
    try {
      ...
      setErrorText(error?.message || "Unable to load profile details.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const loadMemberIntroduction = async () => {
    try {
      ...
      if (success) {
        const intro =
          response?.data?.introduction || response?.introduction || "";
  ...
  const handleSaveAbout = async () => {
    try {
      ...
      const text = String(aboutTextValue || "").trim();

      if (!text) {
        Alert.alert("Required", "Please enter your introduction.");
      ...
      Alert.alert(
        "Error",
        response?.message || "Unable to update introduction.",
      );
    } catch (error) {
      ...
      Alert.alert(
        "Error",
        error?.message || "Something went wrong while updating introduction.",
      );
    } finally {
  ...
  const handleSaveBasicInfo = async () => {
    try {
      ...
      if (success) {
        ...
        Alert.alert(
          "Error",
          response?.message || "Unable to update basic information.",
        );
      }
    } catch (error) {
    ...
    try {
      ...
      if (success && address && typeof address === "object") {
        const formattedAddress = {
          ...
          city_id: address.city_id ?? address.city?.id ?? address.cityId ?? "",
  ...
  const handleSavePresentAddress = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Success",
        response?.message || "Present address updated successfully.",
      );
    } catch (error) {
...
===================================================== */
  ...
  const loadMemberCountries = async () => {
    try {
      ...
      const normalizedCountries = rawList
        .map((item) => {
          if (item == null) {
            return null;
          }
    ...
    try {
      ...
      const normalizedStates = rawList
        .map((item) => {
          ...
          const id =
            typeof item === "object"
              ? (item.id ?? item.state_id ?? item.stateId ?? item.value ?? "")
              : item;
    ...
    try {
      ...
      const normalizedCities = rawList
        .map((item) => {
          ...
          const id =
            typeof item === "object"
              ? (item.id ?? item.city_id ?? item.cityId ?? item.value ?? "")
              : item;
            ...
            <View style={styles.heroDetails}>
              ...
              <View style={styles.nameRow}>
                <Text style={styles.profileName} numberOfLines={1}>
                  {basicInfo?.first_name || PROFILE.name}
              ...
              <View style={styles.heroTags}>
                <View style={styles.heroTag}>
                  <Ionicons name="resize-outline" size={11} color="#FFD54F" />

                  <Text style={styles.heroTagText}>5'7"</Text>
                </View>
      ...
      ================================================= */}
        ...
        >
          <View style={styles.aboutIconBox}>
            <Ionicons name="person-outline" size={23} color="#D51F32" />
          </View>
          ...
          <View style={styles.aboutContent}>
            ...
            <Text style={styles.aboutDescription} numberOfLines={3}>
              {introduction?.trim() ? introduction : PROFILE.about}
            </Text>
          </View>
...
================================================= */}
        ...
        <View style={styles.sectionList}>
          ...
          >
            ...
            >
              <Ionicons name="card-outline" size={21} color="#D3263A" />
            </View>
        ...
        ================================================= */}
          ...
          >
            <View style={[styles.rowIcon, { backgroundColor: "#EAF9F1" }]}>
              <Ionicons name="location-outline" size={22} color="#1AA968" />
            </View>

            <Text style={styles.rowTitle}>Present Address</Text>
        ...
        ================================================= */}
          ...
          >
            <View style={[styles.rowIcon, { backgroundColor: "#FFF7E5" }]}>
              <Ionicons name="school-outline" size={21} color="#E49A15" />
            </View>

            <Text style={styles.rowTitle}>Education Information</Text>
        ...
        ================================================= */}
          ...
          >
            <View style={[styles.rowIcon, { backgroundColor: "#FFF7E5" }]}>
              <Ionicons name="briefcase-outline" size={20} color="#E49A15" />
            </View>

            <Text style={styles.rowTitle}>Career Information</Text>
        ...
        ================================================= */}
          ...
          >
            <View style={[styles.rowIcon, { backgroundColor: "#F3EAFE" }]}>
              <Ionicons name="language-outline" size={21} color="#7538B7" />
            </View>
        ...
        ================================================= */}
          ...
          >
            ...
            <Text style={styles.rowTitle}>Spiritual & Social Background</Text>
        ...
        ================================================= */}
          ...
          >
            <View style={[styles.rowIcon, { backgroundColor: "#FFF4E5" }]}>
              <Ionicons name="moon-outline" size={21} color="#E49D17" />
            </View>

            <Text style={styles.rowTitle}>Astronomic Information</Text>
        ...
        ================================================= */}
          ...
          >
            <View style={[styles.rowIcon, { backgroundColor: "#FFF0F2" }]}>
              <Ionicons name="people-outline" size={21} color="#D3263A" />
            </View>

            <Text style={styles.rowTitle}>Family Information</Text>
        ...
        <View style={styles.aboutModalOverlay}>
          <View style={styles.aboutModal}>
            <View style={styles.modalHeader}>
              ...
              <TouchableOpacity onPress={() => setEditingAbout(false)}>
            ...
            <TouchableOpacity
              ...
              onPress={async () => {
                if (typeof handleSaveAbout === "function") {
