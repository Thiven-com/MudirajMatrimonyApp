...
const EditAstronomicInformation = () => {
  ...
  const loadAstronomicInformation = async () => {
    try {
      ...
      const response =
        await getMemberAstronomic(accessToken);
